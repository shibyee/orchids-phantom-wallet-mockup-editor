...
function EyeIcon() {return <img src="https://img.icons8.com/ios-filled/50/ffffff/visible.png" className="w-[22px] h-[22px] opacity-40" />;}"use client";
        ...
        <AnimatePresence mode="wait">
          ...
          <motion.main
            ...
            className="flex flex-col px-4 pt-3">
              ...
              <div className="relative mb-4 flex ite